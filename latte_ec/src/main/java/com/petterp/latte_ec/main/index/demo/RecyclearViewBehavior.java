package com.petterp.latte_ec.main.index.demo;
 ...
 */
public class RecyclearViewBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public RecyclearViewBehavior() {
    }

    public RecyclearViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
