...
import com.petterp.latte_ec.presenter.CreateUserPresenter;
 ...
 * @date 2019-08-01
 */
@CreatePresenter(CreateUserPresenter.class)
public class CreateUserDelegate extends BaseFragment<CreateUserPresenter> implements ICreateUserView {
    ...
    void createUser() {
        ...
        map.put(MuiltFileds.USER_PHONE, CreateUserDelegateArgs.fromBundle(getArguments()).getPhone());
        ...
        CallbackManager.getInstance().getCallback(DrawUserUpdateFieds.USER_ICON_UPDATE).executeCallback(imgUrl);
        Navigation.findNavController(getRootView()).popBackStack(R.id.homeDelegate, false);
    }
